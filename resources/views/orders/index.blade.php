...
<head>
    ...
    <style>
        ...
        /* Additional styles for the order tables */
        .table {
            width: 100%;
        ...
        /* Style for the "Edit Order" button */
        .btn-edit {
            display: block;
            padding: 10px 15px;
        ...
        /* Style for the "Delete Order" button */
        .btn-delete {
            display: block;
            padding: 10px 15px;
            ...
            <table class="table mt-3">
                <thead>
                    <tr>
                        ...
                        <th>Refuse</th> <!-- Delete column -->
                    </tr>
                </thead>
                <tbody>
                    <!-- Loop through the orders to display data in the right table -->
